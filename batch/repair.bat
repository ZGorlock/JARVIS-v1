...
if exist "..\batch\delpack.bat" (
) else (
copy /y "..\bin\clean\delpack.bat" "..\batch\delpack.bat"
)
...
if exist "..\include\array.bas" (
) else (
copy /y "..\bin\clean\array.bas" "..\include\array.bas"
)
if exist "..\include\const.bas" (
) else (
copy /y "..\bin\clean\const.bas" "..\include\const.bas"
)
if exist "..\include\customcmd.bas" (
) else (
copy /y "..\bin\clean\customcmd.bas" "..\include\customcmd.bas"
)
if exist "..\include\dim.bas" (
) else (
copy /y "..\bin\clean\dim.bas" "..\include\dim.bas"

if exist "..\include\func.bas" (
) else (
copy /y "..\bin\clean\func.bas" "..\include\func.bas"
)
if exist "..\include\lib.bas" (
) else (
copy /y "..\bin\clean\lib.bas" "..\include\lib.bas"
)
if exist "..\include\sound.bas" (
) else (
copy /y "..\bin\clean\sound.bas" "..\include\sound.bas"
)
if exist "..\include\sub.bas" (
) else (
copy /y "..\bin\clean\sub.bas" "..\include\sub.bas"
)
if exist "..\include\tcpip.bas" (
) else (
copy /y "..\bin\clean\tcpip.bas" "..\include\tcpip.bas"
)
if exist "..\include\type.bas" (
) else (
copy /y "..\bin\clean\type.bas" "..\include\type.bas"
)
...
if exist "..\tools\packuninstaller.bas" (
) else (
copy /y "..\bin\clean\packuninstaller.bas" "..\tools\packuninstaller.bas"
)
...
if exist "..\temp\packun.tmp" (
) else (
copy /y "..\bin\clean\packun.tmp" "..\temp\packun.tmp"
)
...
if exist "..\tools\packuninstaller.exe" (
) else (
copy /y "..\bin\clean\packuninstaller.exe" "..\tools\packuninstaller.exe"
)
