IF usercommand$(runcommands) = "until" THEN
    DO
            ...
            IF usercommand$(runcommands2) = "birthday" THEN
                ...
                ELSE
                    IF month2 = month1 THEN
                        ...
                        ELSE
                            IF day2 = day1 THEN
                                speechoutput$ = "today it is your birthday, " + username$
        ...
        IF eventmonth THEN
            ...
            IF VAL(hours$) THEN speechoutput$ = speechoutput$ + hours$ + " hours"
            IF VAL(minutes$) THEN speechoutput$ = speechoutput$ + minutes$ + " minutes"
            speechoutput$ = speechoutput$ + " until the month of " + STR$(findevent)
        END IF
        IF VAL(findevent$) OR WordToNum(findevent$) > 0 THEN
            ...
            SELECT CASE findevent
                ...
                CASE IS < 1300
                    ...
                    IF VAL(hours$) THEN speechoutput$ = speechoutput$ + hours$ + " hours"
                    IF VAL(minutes$) THEN speechoutput$ = speechoutput$ + minutes$ + " minutes"
                    speechoutput$ = speechoutput$ + " until " + STR$(eventhour) + ":" + STR$(eventmin)
                CASE ELSE
        ...
        END IF
        highest = 0
        FOR eventcheck = 1 TO eventramnameload
            gocheckevent = 0
            ...
            IF gocheckevent = 1 THEN
                eventcheckval = Compare(event$, events$(eventcheck))
